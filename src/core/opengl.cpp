...
void wf::gles::render_target_logic_scissor(const wf::render_target_t& target, wf::geometry_t box)
{
...
{
    render_target_logic_scissor(target, geometry_from_pixman_box(box));
}
